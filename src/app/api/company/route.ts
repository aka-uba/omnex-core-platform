    ...
    async (tenantPrisma) => {
      try {
        ...
        return successResponse({
          ...
          faviconFile: (company as any).faviconFile,
          pwaIcon: (company as any).pwaIcon,
          pwaIconFile: (company as any).pwaIconFile,
      ...
      try {
        ...
        const updatedCompany = await tenantPrisma.company.update({
          ...
          data: {
            ...
            faviconFile: body.faviconFile,
            pwaIcon: body.pwaIcon,
            pwaIconFile: body.pwaIconFile,
        ...
        return successResponse({
          ...
          favicon: (updatedCompany as any).favicon,
          faviconFile: (updatedCompany as any).faviconFile,
          pwaIcon: (updatedCompany as any).pwaIcon,
          pwaIconFile: (updatedCompany as any).pwaIconFile,
