...
export function WhatsAppTemplatesTab({ locale }: { locale: string }) {
  ...
  const { data, isLoading, error, refetch } = useQuery<WhatsAppTemplate[]>({
    queryKey: ['notificationTemplates', 'whatsapp', categoryFilter, typeFilter],
    queryFn: async () => {
  ...
  const columns: DataTableColumn[] = [
    {
      ...
      label: t('table.name'),
      sortable: true,
      render: (value, row: WhatsAppTemplate) => (
        <Group gap="xs">
      ...
      render: (value, row: WhatsAppTemplate) => (
        <Group gap="xs" justify="flex-end">
          <ActionIcon
            variant="subtle"
            color="blue"
            onClick={() => router.push(`/${locale}/settings/notification-templates/whatsapp/${row.id}/edit`)}
    ...
    <Stack gap="md">
      <Group>
        ...
        <Button
          ...
          onClick={() => router.push(`/${locale}/settings/notification-templates/whatsapp/create`)}
          variant="filled"
        >
          {t('create')}
        </Button>
