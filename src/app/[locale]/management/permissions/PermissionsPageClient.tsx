  ...
  const handleExport = async (format: 'pdf' | 'excel' | 'csv' | 'word' | 'html' | 'print') => {
    ...
    try {
      ...
      const exportData = {
        ...
        rows: exportRows,
        metadata: {
          title: t('titles.izinler'),
          description: t('titles.izin.listesi'),
        },
      };
  ...
  return (
    <Container size="xl" pt="xl">
            ...
            <Table.Tbody>
              {data?.permissions.map((permission) => (
                <Table.Tr key={permission.id}>
                  ...
                  {visibleColumns.includes(t('table.description')) && (
                    <Table.Td>
      ...
      <ColumnSettingsModal
        ...
        onReset={() => {
          setColumnOrder(['permissionKey', 'name', t('common.description'), 'category', 'module']);
          setHiddenColumns([]);
        }}
      />
    </Container>
