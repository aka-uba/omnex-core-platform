...
export function EditEmailTemplatePageClient({ locale, templateId }: { locale: string; templateId: string }) {
  ...
  return (
    <Container size="xl" pt="xl">
      <CentralPageHeader
        title={t('email.templates.edit.title')}
        description={t('email.templates.edit.description')}
        ...
        breadcrumbs={[
          ...
          { label: 'email.templates.edit.title', namespace: 'modules/real-estate' },
        ]}
      />
      <EmailTemplateForm locale={currentLocale} templateId={templateId} />
    </Container>
  );
}
