...
export function EditPaymentPageClient({ locale }: { locale: string }) {
  ...
  return (
    <Container size="xl" pt="xl">
      <CentralPageHeader
        ...
        description={t('payments.edit.description')}
        ...
        breadcrumbs={[
          ...
          { label: t('payments.edit.title'), namespace: 'modules/real-estate' },
        ]}
      />
      <PaymentForm locale={currentLocale} paymentId={paymentId} />
    </Container>
  );
}
