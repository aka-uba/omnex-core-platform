...
export function CreateExpensePageClient({ locale }: { locale: string }) {
  ...
  return (
    <Container size="xl" pt="xl">
      <CentralPageHeader
        title={t('templates.create.expense.title')}
        description={t('templates.create.expense.description')}
      ...
      />
      <ExpenseForm locale={currentLocale} />
    </Container>
  );
}
