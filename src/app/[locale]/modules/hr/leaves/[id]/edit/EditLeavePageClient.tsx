...
export function EditLeavePageClient({ locale, leaveId }: { locale: string; leaveId: string }) {
  ...
  return (
    <Container size="xl" pt="xl">
      <CentralPageHeader
        title={t('leaves.edit')}
        description={t('leaves.editDescription')}
        ...
        breadcrumbs={[
          ...
          { label: 'leaves.edit', namespace: 'modules/hr' },
        ]}
      />
      <LeaveForm locale={currentLocale} leaveId={leaveId} />
    </Container>
  );
}
