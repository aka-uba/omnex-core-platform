...
export const propertySchema = z.object({
  ...
  totalUnits: z.coerce.number().min(0).optional().nullable(),
  ...
  constructionYear: z.coerce.number().min(1800).max(2100).optional().nullable(),
  lastRenovationDate: z.coerce.date().optional().nullable(),
  landArea: z.coerce.number().min(0).optional().nullable(),
  floorCount: z.coerce.number().min(1).optional().nullable(),
  livingArea: z.coerce.number().min(0).optional().nullable(),
  ...
  monthlyFinancingRate: z.coerce.number().min(0).optional().nullable(),
  numberOfInstallments: z.coerce.number().min(1).optional().nullable(),
  financingPaymentDay: z.coerce.number().min(1).max(31).optional().nullable(),
