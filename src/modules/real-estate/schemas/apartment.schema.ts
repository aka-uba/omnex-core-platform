...
export const apartmentSchema = z.object({
  ...
  roomCount: z.coerce.number().int().min(0, 'Room count must be non-negative'),
  livingRoom: z.boolean().default(true),
  bathroomCount: z.coerce.number().int().min(1, 'Bathroom count must be at least 1').default(1),
  balcony: z.boolean().default(false),
  apartmentType: z.string().optional().nullable(),
  bedroomCount: z.coerce.number().int().min(0).optional().nullable(),
  basementSize: z.coerce.number().min(0).optional().nullable(),
  ...
  coldRent: z.coerce.number().min(0).optional().nullable(),
  heatingCosts: z.coerce.number().min(0).optional().nullable(),
  additionalCosts: z.coerce.number().min(0).optional().nullable(),
