...
chcp 65001 >nul 2>&1
echo ========================================
echo   Omnex Core Platform - Production Server (WSL2)
echo ========================================
echo.
...
echo [BILGI] WSL2'de production server baslatiliyor...
echo.
...
echo.
wsl -e bash -c "cd '!WSL_PATH!' && chmod +x start-prod.sh 2>/dev/null; bash start-prod.sh"
